    ...
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      <nav
        className={`mx-auto flex max-w-6xl items-center justify-between px-5 transition-all duration-300 sm:px-8 ${
          scrolled
            ? "my-3 rounded-2xl border border-white/10 bg-ink-900/70 py-3 shadow-lg shadow-black/30 backdrop-blur-xl"
            : "py-5"
        }`}
      >
        <button
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden items-center gap-2 rounded-xl bg-gradient-to-r from-brand-500 to-accent-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-brand-500/25 transition-transform hover:-translate-y-0.5 sm:inline-flex"
          >
      ...
      <div
        className={`mx-4 overflow-hidden rounded-2xl border border-white/10 bg-ink-900/95 backdrop-blur-xl transition-all duration-300 lg:hidden ${
